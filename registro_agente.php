...
<body>
    ...
    <script>
        // JS para el toggle del menú
        // Toggle para desktop (minimizar/expandir a iconos)
        document.getElementById('sidebar-toggle-desktop').addEventListener('click', function() {
            document.getElementById('wrapper').classList.toggle('toggled-desktop');
        });

        // Toggle para mobile (mostrar/ocultar completamente) - Este es el botón en el navbar
        document.getElementById('sidebar-toggle-mobile').addEventListener('click', function() {
            document.getElementById('wrapper').classList.toggle('toggled-mobile');
        });

        // Botón de cierre para móvil dentro de la sidebar
        document.getElementById('sidebar-close-mobile').addEventListener('click', function() {
            document.getElementById('wrapper').classList.remove('toggled-mobile'); // Elimina la clase para ocultar
        });
    </script>
</body>
</html>